...
if __name__ == "__main__":
    ...
    U_map = np.zeros((data_size, 3))
    shm = shared_memory.SharedMemory(name="shared_L_map", create=True, size=U_map.nbytes)
    ...
    savemat("L_ori_map"+"_.mat", data_dict)
