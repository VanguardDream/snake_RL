...
static const _MotorStates_type_support_symbol_names_t _MotorStates_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, horcrux_interfaces, msg, MotorStates)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, horcrux_interfaces, msg, MotorStates)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, horcrux_interfaces, msg, MotorStates)() {
  return &::horcrux_interfaces::msg::rosidl_typesupport_c::MotorStates_message_type_support_handle;
}
