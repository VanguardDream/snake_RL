...
#include "horcrux_interfaces/msg/detail/motor_states__rosidl_typesupport_fastrtps_c.h"
...
#include "horcrux_interfaces/msg/detail/motor_state__functions.h"  // motors
...
using _MotorStates__ros_msg_type = horcrux_interfaces__msg__MotorStates;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: motors
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, horcrux_interfaces, msg, MotorState
      )()->data);
    size_t size = 14;
  ...
  size_t current_alignment)
{
  ...
  // field.name motors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_horcrux_interfaces__msg__MotorState(
...
static uint32_t _MotorStates__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_horcrux_interfaces__msg__MotorStates(
  ...
  size_t current_alignment)
{
  ...
  // member: motors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_horcrux_interfaces__msg__MotorState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = horcrux_interfaces__msg__MotorStates;
    is_plain =
      (
...
static size_t _MotorStates__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_horcrux_interfaces__msg__MotorStates(
