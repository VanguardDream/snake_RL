...
#include "horcrux_interfaces/msg/detail/robot_state__rosidl_typesupport_fastrtps_c.h"
...
#include "horcrux_interfaces/msg/detail/motor_states__functions.h"  // motors
...
size_t get_serialized_size_horcrux_interfaces__msg__MotorStates(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_horcrux_interfaces__msg__MotorStates(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, horcrux_interfaces, msg, MotorStates)();
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_horcrux_interfaces
...
using _RobotState__ros_msg_type = horcrux_interfaces__msg__RobotState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: motors
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, horcrux_interfaces, msg, MotorStates
      )()->data);
    if (!callbacks->cdr_serialize(
...
size_t get_serialized_size_horcrux_interfaces__msg__RobotState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RobotState__ros_msg_type * ros_message = static_cast<const _RobotState__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_horcrux_interfaces__msg__MotorStates(
...
static uint32_t _RobotState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_horcrux_interfaces__msg__RobotState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_horcrux_interfaces
size_t max_serialized_size_horcrux_interfaces__msg__RobotState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: motors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_horcrux_interfaces__msg__MotorStates(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = horcrux_interfaces__msg__RobotState;
    is_plain =
      (
...
static size_t _RobotState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_horcrux_interfaces__msg__RobotState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, horcrux_interfaces, msg, RobotState)() {
