...
#include "horcrux_interfaces/msg/detail/motor_states__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const horcrux_interfaces::msg::MotorState &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  size_t current_alignment)
{
  ...
  // Member: motors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        horcrux_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_MotorState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = horcrux_interfaces::msg::MotorStates;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const horcrux_interfaces::msg::MotorStates *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<horcrux_interfaces::msg::MotorStates *>(
    untyped_ros_message);
...
{
  return &horcrux_interfaces::msg::typesupport_fastrtps_cpp::_MotorStates__handle;
}
