...
#include "horcrux_interfaces/msg/detail/robot_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const horcrux_interfaces::msg::MotorStates &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  horcrux_interfaces::msg::MotorStates &);
size_t get_serialized_size(
  const horcrux_interfaces::msg::MotorStates &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const horcrux_interfaces::msg::RobotState & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ...
    cdr);
  // Member: motors
  horcrux_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.motors,
    cdr);
  // Member: joy
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  horcrux_interfaces::msg::RobotState & ros_message)
{
  // Member: header
  ...
  // Member: motors
  horcrux_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    horcrux_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: motors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        horcrux_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_MotorStates(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = horcrux_interfaces::msg::RobotState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const horcrux_interfaces::msg::RobotState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<horcrux_interfaces::msg::RobotState *>(
    untyped_ros_message);
...
{
  return &horcrux_interfaces::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, horcrux_interfaces, msg, RobotState)() {
  return &horcrux_interfaces::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
