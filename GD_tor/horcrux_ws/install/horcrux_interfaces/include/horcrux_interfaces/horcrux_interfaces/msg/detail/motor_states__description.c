...
static char horcrux_interfaces__msg__MotorStates__FIELD_NAME__header[] = "header";
static char horcrux_interfaces__msg__MotorStates__FIELD_NAME__motors[] = "motors";

static rosidl_runtime_c__type_description__Field horcrux_interfaces__msg__MotorStates__FIELDS[] = {
  {
    {horcrux_interfaces__msg__MotorStates__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {horcrux_interfaces__msg__MotorStates__FIELD_NAME__motors, 6, 6},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription horcrux_interfaces__msg__MotorStates__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {horcrux_interfaces__msg__MotorStates__FIELDS, 2, 2},
    },
    {horcrux_interfaces__msg__MotorStates__REFERENCED_TYPE_DESCRIPTIONS, 3, 3},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[1].fields = horcrux_interfaces__msg__MotorState__get_type_description(NULL)->type_description.fields;
...
static char toplevel_type_raw_source[] =
  ...
  "\n"
  "# Motor States\n"
  "horcrux_interfaces/MotorState[14] motors";
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *horcrux_interfaces__msg__MotorStates__get_individual_type_description_source(NULL),
    sources[1] = *builtin_interfaces__msg__Time__get_individual_type_description_source(NULL);
    sources[2] = *horcrux_interfaces__msg__MotorState__get_individual_type_description_source(NULL);
