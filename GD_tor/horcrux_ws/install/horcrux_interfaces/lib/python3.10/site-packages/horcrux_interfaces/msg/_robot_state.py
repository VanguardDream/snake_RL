    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'horcrux_interfaces.msg.RobotState')
            logger.debug(
            ...
            if MotorStates.__class__._TYPE_SUPPORT is None:
                MotorStates.__class__.__import_type_support__()
...
class RobotState(metaclass=Metaclass_RobotState):
    ...
    _fields_and_field_types = {
        ...
        'motors': 'horcrux_interfaces/MotorStates',
        'joy': 'sensor_msgs/Joy',
        'imu': 'sensor_msgs/Imu',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['horcrux_interfaces', 'msg'], 'MotorStates'),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        from horcrux_interfaces.msg import MotorStates
        self.motors = kwargs.get('motors', MotorStates())
        from sensor_msgs.msg import Joy
    ...
    def motors(self, value):
        if self._check_fields:
            from horcrux_interfaces.msg import MotorStates
            assert \
                isinstance(value, MotorStates), \
                "The 'motors' field must be a sub message of type 'MotorStates'"
        self._motors = value
