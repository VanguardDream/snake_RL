...
class PlaneWorld_control(MujocoEnv, utils.EzPickle):
    metadata = {
        "render_modes": [
            "human",
            "rgb_array",
    ...
    def __init__(
        ...
        self.action_space = Box(
                low=-1.5, high=1.5, shape=(14,), dtype=np.float32
        )
    ...
    def step(self, action):
        ...
        info = {
            ...
            "head_quat": observation[28:32].copy(),
            "head_ang_vel": observation[32:35].copy(),
            "head_lin_acc": observation[35:38].copy(),
    ...
    def _get_obs(self):
          return self.data.sensordata.flatten().copy()
