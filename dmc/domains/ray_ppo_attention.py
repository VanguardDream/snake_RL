...
algo = (
    ...
    .framework('torch')
    .training(gamma=0.995, lr=0.0001, clip_param=0.2, kl_coeff=1.0, num_sgd_iter=20, sgd_minibatch_size=16384, train_batch_size=320000, model= {"fcnet_hiddens": [256, 256, 128, 128, 64], "use_attention": True,}, )
    .build()
)
