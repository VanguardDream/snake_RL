...
class SnakeEnv(MujocoEnv, utils.EzPickle):
    ...
    def __init__(self, frame_skip = 100, **kwargs,) -> None:
        ...
        MujocoEnv.__init__(self, os.path.join(__model_location__,'snake_roll.xml'), frame_skip, observation_space= self.observation_space, **kwargs)
    ...
    def step(self, action):
        ...
        if (np.round(self.data.time * (1/10))) >= 10 * np.shape(self.M_matrix)[1]: #Check! MuJoCo 10 Sim-step -> RL 1 action step!
