...
def mj_activate(filename: str) -> int: ...
...
def mj_constraintUpdate(m: mujoco._structs.MjModel, d: mujoco._structs.MjData, jar: numpy.ndarray[numpy.float64[m,1]], cost: Optional[numpy.ndarray[numpy.float64[1,1],flags.writeable]], flg_coneHessian: int) -> None: ...
...
def mj_jac(m: mujoco._structs.MjModel, d: mujoco._structs.MjData, jacp: Optional[numpy.ndarray[numpy.float64[m,n],flags.writeable,flags.c_contiguous]], jacr: Optional[numpy.ndarray[numpy.float64[m,n],flags.writeable,flags.c_contiguous]], point: numpy.ndarray[numpy.float64[3,1]], body: int) -> None: ...
def mj_jacBody(m: mujoco._structs.MjModel, d: mujoco._structs.MjData, jacp: Optional[numpy.ndarray[numpy.float64[m,n],flags.writeable,flags.c_contiguous]], jacr: Optional[numpy.ndarray[numpy.float64[m,n],flags.writeable,flags.c_contiguous]], body: int) -> None: ...
def mj_jacBodyCom(m: mujoco._structs.MjModel, d: mujoco._structs.MjData, jacp: Optional[numpy.ndarray[numpy.float64[m,n],flags.writeable,flags.c_contiguous]], jacr: Optional[numpy.ndarray[numpy.float64[m,n],flags.writeable,flags.c_contiguous]], body: int) -> None: ...
def mj_jacGeom(m: mujoco._structs.MjModel, d: mujoco._structs.MjData, jacp: Optional[numpy.ndarray[numpy.float64[m,n],flags.writeable,flags.c_contiguous]], jacr: Optional[numpy.ndarray[numpy.float64[m,n],flags.writeable,flags.c_contiguous]], geom: int) -> None: ...
...
def mj_jacSite(m: mujoco._structs.MjModel, d: mujoco._structs.MjData, jacp: Optional[numpy.ndarray[numpy.float64[m,n],flags.writeable,flags.c_contiguous]], jacr: Optional[numpy.ndarray[numpy.float64[m,n],flags.writeable,flags.c_contiguous]], site: int) -> None: ...
def mj_jacSubtreeCom(m: mujoco._structs.MjModel, d: mujoco._structs.MjData, jacp: Optional[numpy.ndarray[numpy.float64[m,n],flags.writeable,flags.c_contiguous]], body: int) -> None: ...
...
def mj_ray(m: mujoco._structs.MjModel, d: mujoco._structs.MjData, pnt: numpy.ndarray[numpy.float64[3,1]], vec: numpy.ndarray[numpy.float64[3,1]], geomgroup: Optional[numpy.ndarray[numpy.uint8[6,1]]], flg_static: int, bodyexclude: int, geomid: numpy.ndarray[numpy.int32[1,1],flags.writeable]) -> float: ...
...
def mj_saveModel(m: mujoco._structs.MjModel, filename: Optional[str], buffer: Optional[numpy.ndarray[numpy.uint8[m,1],flags.writeable]]) -> None: ...
...
def mjd_transitionFD(m: mujoco._structs.MjModel, d: mujoco._structs.MjData, eps: float, centered: int, A: Optional[numpy.ndarray[numpy.float64[m,n],flags.writeable,flags.c_contiguous]], B: Optional[numpy.ndarray[numpy.float64[m,n],flags.writeable,flags.c_contiguous]], C: Optional[numpy.ndarray[numpy.float64[m,n],flags.writeable,flags.c_contiguous]], D: Optional[numpy.ndarray[numpy.float64[m,n],flags.writeable,flags.c_contiguous]]) -> None: ...
...
def mju_boxQP(res: numpy.ndarray[numpy.float64[m,1],flags.writeable], R: numpy.ndarray[numpy.float64[m,n],flags.writeable,flags.c_contiguous], index: Optional[numpy.ndarray[numpy.int32[m,1],flags.writeable]], H: numpy.ndarray[numpy.float64[m,n],flags.c_contiguous], g: numpy.ndarray[numpy.float64[m,1]], lower: Optional[numpy.ndarray[numpy.float64[m,1]]], upper: Optional[numpy.ndarray[numpy.float64[m,1]]]) -> int: ...
...
def mju_copy(res: numpy.ndarray[numpy.float64[m,1],flags.writeable], data: numpy.ndarray[numpy.float64[m,1]]) -> None: ...
...
def mju_muscleDynamics(ctrl: float, act: float, prm: numpy.ndarray[numpy.float64[2,1]]) -> float: ...
...
def mju_normalize3(res: numpy.ndarray[numpy.float64[3,1],flags.writeable]) -> float: ...
def mju_normalize4(res: numpy.ndarray[numpy.float64[4,1],flags.writeable]) -> float: ...
...
def mju_sqrMatTD(res: numpy.ndarray[numpy.float64[m,n],flags.writeable,flags.c_contiguous], mat: numpy.ndarray[numpy.float64[m,n],flags.c_contiguous], diag: Optional[numpy.ndarray[numpy.float64[m,1],flags.writeable]]) -> None: ...
def mju_standardNormal(num2: Optional[float]) -> float: ...
...
def mjv_select(m: mujoco._structs.MjModel, d: mujoco._structs.MjData, vopt: mujoco._structs.MjvOption, aspectratio: float, relx: float, rely: float, scn: mujoco._structs.MjvScene, selpnt: numpy.ndarray[numpy.float64[3,1],flags.writeable], geomid: numpy.ndarray[numpy.int32[1,1],flags.writeable], skinid: numpy.ndarray[numpy.int32[1,1],flags.writeable]) -> int: ...
...
def mjv_updateScene(m: mujoco._structs.MjModel, d: mujoco._structs.MjData, opt: mujoco._structs.MjvOption, pert: Optional[mujoco._structs.MjvPerturb], cam: mujoco._structs.MjvCamera, catmask: int, scn: mujoco._structs.MjvScene) -> None: ...
